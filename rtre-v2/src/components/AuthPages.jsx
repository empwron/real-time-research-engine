...
const Field = ({ label, value, onChange, type='text', placeholder='', hint='' }) => (
  <div style={{ marginBottom:18 }}>
    <label style={{ fontSize:13, color:'rgba(200,230,200,.55)', display:'block', marginBottom:6 }}>
      {label}{hint&&<span style={{fontSize:11,color:'rgba(200,230,200,.3)',marginLeft:6}}>{hint}</span>}
    </label>
